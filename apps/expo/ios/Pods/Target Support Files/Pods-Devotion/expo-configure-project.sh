...
with_node \
  ...
  --target "/Users/kalemedlin/Developer/monoexpo/apps/expo/ios/Pods/Target Support Files/Pods-Devotion/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-document-picker" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-router" "expo-secure-store" "expo-system-ui" "expo-web-browser"
